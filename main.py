...
'''
DISCLAIMER ABOUT THIS PART: the city that was used on this project
...
bigger = df_passenger[df_passenger.passenger > 500]
df_passenger = df_passenger[df_passenger.passenger < 500]
zeros = df_passenger[df_passenger.passenger == 0]
df_passenger = df_passenger[df_passenger.passenger != 0]
negatives = df_passenger[df_passenger.passenger < 0]
df_passenger = df_passenger[df_passenger.passenger > 0]
'''
...
graphics.best_model_graphics(Results_fulldataset)
graphics.best_model_graphics(Results_prepandemic_data)
graphics.best_model_graphics(Results_pandemic_data)
